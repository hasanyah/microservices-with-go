...
func (mw LoggingMiddleware) Find(c context.Context, s string) (output []Album, err error) {
...
func (mw InstrumentingMiddleware) Find(c context.Context, s string) (output []Album, err error) {
	defer func(begin time.Time) {
